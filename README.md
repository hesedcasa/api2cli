...
running command...
$ api (--version)
@hesed/api2cli/0.5.1 linux-x64 node-v22.23.1
$ api --help [COMMAND]
USAGE
  $ api COMMAND
...
...
_See code: [src/commands/api/auth/add.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/auth/add.ts)_
...
_See code: [src/commands/api/auth/delete.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/auth/delete.ts)_
...
_See code: [src/commands/api/auth/list.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/auth/list.ts)_
...
_See code: [src/commands/api/auth/profile.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/auth/profile.ts)_
...
_See code: [src/commands/api/auth/update.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/auth/update.ts)_
...
_See code: [src/commands/api/call.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/call.ts)_
...
_See code: [src/commands/api/config.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/config.ts)_
...
_See code: [src/commands/api/import.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/import.ts)_
...
_See code: [src/commands/api/list.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/list.ts)_
...
_See code: [src/commands/api/remove.ts](https://github.com/hesedcasa/api2cli/blob/v0.5.1/src/commands/api/remove.ts)_
<!-- commandsstop -->
